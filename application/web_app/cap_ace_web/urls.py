...
from .import views 
from .game_views import  MultipleChoiceGameView, BudgetSimulationGameView, FillInTheBlankCreateView, FillInTheBlankDeleteView, FillInTheBlankDetailView, FillInTheBlankListView, FillInTheBlankGameView
